...
dataset_path = 'F:/MS/2ndSemester/Big Data Analytics/Lab1'
img_building = cv2.imread(os.path.join(dataset_path, 'traffic.jpg'))
...
orb = cv2.ORB_create()
draw_image_matches(orb, 'traffic.jpg', 'traffic1.jpg')
...
img1, kp1, des1 = image_detect_and_compute(sift, 'traffic.jpg')
img2, kp2, des2 = image_detect_and_compute(sift, 'traffic1.jpg')
